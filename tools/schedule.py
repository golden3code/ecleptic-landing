...
ORDER = [
    ...
    # --- Vague 3 (24/09/2026) : 51 articles pour atteindre 10 par thème. Chaque
    # thème est réparti uniformément sur la période ; publication à la suite
    # (03/12/2026 -> 13/03/2027), même cadence. ---
    "comment-ameliorer-sa-hrv",
    "rpe-echelle-effort-percu",
    "comment-se-lever-tot",
    "depression-saisonniere-luminotherapie",
    "comment-avoir-plus-d-energie-le-matin",
    "s-endormir-rapidement",
    "foam-roller-comment-l-utiliser",
    "sport-le-matin-ou-le-soir",
    "musculation-maison-sans-materiel",
    "jeune-intermittent-et-sport",
    "frequence-cardiaque-repos-elevee",
    "charge-d-entrainement-c-est-quoi",
    "creer-une-habitude-qui-dure",
    "burn-out-signes-avant-coureurs",
    "vitamine-d-fatigue",
    "melatonine-efficace-pour-dormir",
    "massage-recuperation-efficace",
    "sport-pendant-la-grossesse",
    "hrv-basse-que-faire",
    "periodisation-entrainement-bases",
    "combien-de-temps-pour-prendre-une-habitude",
    "meditation-bienfaits-prouves",
    "pic-de-glycemie-fatigue",
    "temperature-ideale-chambre-dormir",
    "courir-tous-les-jours",
    "sommeil-et-recuperation-musculaire",
    "magnesium-sport-fatigue",
    "menopause-et-sport",
    "combien-de-jours-de-repos-par-semaine",
    "blessure-de-surmenage-signes",
    "chronotype-matin-ou-soir",
    "endorphines-comment-en-liberer",
    "boissons-energisantes-effets",
    "dette-de-sommeil-rattraper",
    "combien-de-temps-pour-recuperer-d-une-seance",
    "sport-en-altitude-effets",
    "montre-connectee-fiabilite-sommeil",
    "regle-des-10-pourcent-course",
    "motivation-ou-discipline",
    "sport-et-depression",
    "deshydratation-fatigue-signes",
    "hiit-combien-de-fois-par-semaine",
    "glucides-et-sport-combien",
    "sommeil-paradoxal-role",
    "recuperer-apres-un-marathon",
    "sport-quand-il-fait-chaud",
    "s-entrainer-fatigue-bonne-idee",
    "ratio-charge-aigue-chronique",
    "grasse-matinee-week-end-sommeil",
    "manque-de-sommeil-irritabilite",
    "fatigue-apres-le-sport-normal",
]
